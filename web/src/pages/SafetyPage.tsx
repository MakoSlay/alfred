  ...
  return (
    <div className="page-stack">
      <section className="safety-grid">
        <article className="panel section-panel"><span className="eyebrow">Controls</span><h2>Execution posture</h2><p>Local mutations require confirmation. Destructive work remains explicit even when auto-confirm is enabled.</p><div className="button-row"><button className="button button--primary" onClick={() => void onToggleAutoConfirm()} type="button">{state.autoConfirm ? "Disable auto-confirm" : "Enable auto-confirm"}</button></div></article>
