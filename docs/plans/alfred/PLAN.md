...
| daemon can handle and confirm drafts | In Progress | Task 004 adds authenticated `/handle`, `/state`, and `/surfaces`; draft confirmation execution waits for Task 005. |
